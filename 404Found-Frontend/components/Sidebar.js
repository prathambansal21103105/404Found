...
function Sidebar() {
  ...
  useEffect(()=>{
    router.push(pathname + '?Error=true&Warn=true&info=true&Match_fetcher=true&PyEditorial=true')
  },[])
      ...
      <div className='flex flex-col gap-4 mt-5'>
        ...
        <div className='mx-10'>
          ...
          <input
            ...
            id='Match_fetcher'
            name='Match_fetcher'
            checked={services.Match_fetcher}
            onChange={handleServiceChange}
          />
          <label htmlFor='Match_fetcher'>  Match Fetcher</label><br/>
        </div>
        ...
        <div className='mx-10'>
          ...
          <input
            ...
            onChange={handleStatusChange}
          />
          <label htmlFor='Warn'>  Warn </label><br/>
        </div>
      </div>
    </div>
  )
